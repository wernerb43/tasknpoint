...
MOTIONS: list[MotionCfg] = [
  MotionCfg(  # Tennis Forehand
    ...
    sub_targets=[
      MotionGoalCfg(
        ...
        target_pos_std={"x": 0.10, "y": 0.10, "z": 0.20},
        target_phase_start=0.345,
  ...
  #       target_pos_mean     = {"x": 0.55, "y": 0.3, "z": 0.22},
  #       target_pos_std      = {"x": 0.10, "y": 0.10, "z": 0.10},
  #       target_phase_start  = 0.255,
  #       target_phase_end    = 0.260,
  #     ),
  #     MotionGoalCfg(
  #       goal_type           = "velocity",
  #       goal_weight   = 10.0,
  #       source_link         = "bat_contact", source_type = "site",
  #       target_phase_start  = 0.240,
  #       target_phase_end    = 0.290,
  #       target_vel_mean     = {"x": 0.0, "y": 1.0, "z": 0.1},
  #       target_vel_std      = {"x": 0.0, "y": 0.0, "z": 0.2},
  #     ),
  #   ],
  # ),
...
def make_multi_target_tracking_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  rewards: dict[str, RewardTermCfg] = {
    ...
    "target_velocity_reward": RewardTermCfg(
      func=mdp.all_motions_target_velocity_error_exp,
      weight=1.0,
      params={
        "target_command_name": "motion",
        "std": 1.0,
