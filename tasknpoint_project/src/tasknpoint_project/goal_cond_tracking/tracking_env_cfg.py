  ...
  MotionCfg(  # Right Kick
    ...
    sub_targets=[
      MotionGoalCfg(
        ...
        source_type="site",
        target_pos_mean={"x": 0.5, "y": -0.6, "z": -0.71},
        target_pos_std={"x": 0.10, "y": 0.20, "z": 0.01},
        target_phase_start=0.280,
        target_phase_end=0.287,
      ),
      # MotionGoalCfg(
      #   goal_type="velocity",
      #   goal_weight=10.0,
  ...
  MotionCfg(  # Left Kick
    ...
    sub_targets=[
      MotionGoalCfg(
        ...
        source_type="site",
        target_pos_mean={"x": 0.5, "y": 0.0, "z": -0.71},
        target_pos_std={"x": 0.10, "y": 0.20, "z": 0.01},
  ...
  MotionCfg(  # Right Far Kick
    ...
    sub_targets=[
      MotionGoalCfg(
        ...
        source_link="right_foot",
        source_type="site",
        target_pos_mean={"x": 0.5, "y": -1.2, "z": -0.71},
        target_pos_std={"x": 0.10, "y": 0.20, "z": 0.01},
        target_phase_start=0.394,
        target_phase_end=0.401,
      ),
      # MotionGoalCfg(
      #   goal_type="velocity",
      #   goal_weight=10.0,
    ...
    sub_targets=[
      MotionGoalCfg(
        ...
        source_link="left_foot",
        source_type="site",
        target_pos_mean={"x": 1.0, "y": 0.6, "z": -0.71},
        target_pos_std={"x": 0.10, "y": 0.20, "z": 0.01},
